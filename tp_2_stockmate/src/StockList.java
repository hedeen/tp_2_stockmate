...
public class StockList {
	...
	private String[] sp500 = new String[] { "MMM", "ABT", "ABBV", "ABMD", "ACN", "ATVI", "ADBE", "AMD", "AAP", "AES", "AMG",
	...
	public static void main(String[] args) {
		...
		System.out.println(sl.getDesc("HOFT"));
	...
	public String getDesc(String ticker) {
		...
		try {
			doc = Jsoup.parse(getHTML("https://stockinvest.us/info/"+ticker+""));
			table = doc.select("div[class=col-md-12]").last().selectFirst("p");
			rtn = table.html();
