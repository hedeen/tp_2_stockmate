...
class FileIOTest {
	...
	public void test_file_txt_not_created() throws Exception {
		// same test as above, but don't actually make the file - tests our test code a little bit to make sure we aren't masking any errors
